...
public class ItemFocusBasic extends Item {
	...
	public void addFocusInformation(ItemStack focusstack,EntityPlayer player, List list, boolean par4) {
		...
		for (Short id:map.keySet()) {	
			list.add(ChatFormatting.DARK_PURPLE +FocusUpgradeType.types[id].getLocalizedName()+
	 ...
	 * @param rayTraceResult The target
	 ...
	 */
	public boolean onFocusActivation(ItemStack wandstack, World world, EntityLivingBase entity, RayTraceResult rayTraceResult, int useCount) {
		return true;
	}
